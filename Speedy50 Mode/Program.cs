...
namespace Speedymode
{
    ...
    class Program
    {
        ...
        private static string[] Messages = { "kids are bad and need to know they're bad", "hehe xd", "omg dc", "why?", "laaaaag", "oh my god this lag is unreal",
                                             "rito pls 500 ping", "sorry lag", "i can't carry dis",
                                             "omg so op", "what's up with this lag?", "is the server lagging again?",
                                             "i call black magic", "i was afk", "so lucky", "much wow", "kys" };
